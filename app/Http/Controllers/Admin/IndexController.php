...
class IndexController extends Controller
{
    public function index()
    {
        ...
        $data['increase'] = $data['total'] == 0 ? 0 : $data['difference']/$data['total'] * 100;
        ...
        $data['answered_increase'] = $data['answered_total'] == 0 ? 0 : $data['answered_difference']/$data['answered_total'] * 100;
        ...
        $data['avg_increase'] = $data['avg_total'] == 0 ? 0 : $data['avg_difference']/$data['avg_total'] * 100;
        ...
        $data['max_increase'] = $data['max_total'] == 0 ? 0 : $data['max_difference']/$data['max_total'] * 100;
