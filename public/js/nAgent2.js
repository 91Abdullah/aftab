...
$(document).ready(function () {
    ...
    let randomModeLine2 = document.getElementById('randomModeLine2');
    let scheduleCallLine2 = document.getElementById('scheduleCallLine2');
    let scheduleTableLine2 = document.getElementById('scheduleTableLine2');

    let muteBtnLine2 = document.getElementById('muteBtnLine2');
    let holdBtnLine2 = document.getElementById('holdBtnLine2');
    let holdNotifLine2 = document.getElementById('holdNotifLine2');
    let muteNotifLine2 = document.getElementById('muteNotifLine2');

    let manualDialBtnLine2 = document.getElementById('manualDialBtnLine2');
    let listDialBtnLine2 = document.getElementById('listDialBtnLine2');
    let randomDialBtnLine2 = document.getElementById('randomDialBtnLine2');
    let registerBtnLine2 = document.getElementById('registerBtnLine2');
    let hangupBtnLine2 = document.getElementById('hangupBtnLine2');

    var remoteAudioLine2 = document.getElementById('remoteAudioLine2');
    var localAudioLine2 = document.getElementById('localAudioLine2');

    let phoneStatusLine2 = document.getElementById('phone-statusLine2');
    let agentStatusLine2 = document.getElementById('agent-statusLine2');

    let inCallBtnsLine2 = document.getElementById('inCallBtnsLine2');

    let callStatusLine2 = document.getElementById('callStatusLine2');
    let callNotifLine2 = document.getElementById('callNotifLine2');

    let inputNumberLine2 = document.getElementById('inputNumberLine2');

    let mvisibleLine2 = false;
    let hVisibleLine2 = false;
    let minsLine2 = 0;
    let secondsLine2 = 0;
    let timexLine2 = undefined;
    let random_modeLine2 = false;

    let currentSessionLine2 = undefined;
    let currentNumberLine2 = "";
    let callIDLine2 = undefined;
